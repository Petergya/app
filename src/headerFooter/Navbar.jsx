...
export default function Navbar() {
  ...
  return (
    <nav
      className="bg-white text-gray-800 py-4 shadow-md fixed w-full z-10"
      style={{ top: "0px" }}
    >
      <div className="container mx-auto flex items-center justify-between px-8">
        <div className="flex items-center space-x-10">
          ...
          <div className="hidden md:flex space-x-10">
            <Link href="/welcome" className="text-lg hover:text-gray-600">
              Welcome to
            </Link>
            <Link href="/addProduct" className="text-lg hover:text-gray-600">
              Add Items
            </Link>
